...
class BriefShortlistReportScreen extends StatelessWidget {
  const BriefShortlistReportScreen({super.key});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _Stat(label: 'CONFIDENCE', value: 'High'),
            ],
          ),
        ],
      ),
  ...
  Widget _buildCandidateList() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('AI Recommended Shortlist',
            style: TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.bold,
                color: HireIQColors.navy)),
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton(
            onPressed: () {},
            child: const Text('View Full CVs'),
          ),
        ),
      ],
    );
